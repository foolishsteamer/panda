...
document.getElementById('asm').innerHTML+='<div id="panda_gplus" class="gm" style="text-align:center;"><h4>页码&nbsp;<input id="panda_picsfrom" style="width:50px;" value="'+panda_gnavi[1].replace(/,/g,'')+'" />&nbsp;-&nbsp;<input id="panda_picsfinl" size="3" style="width:50px;" value="'+panda_gnavi[2].replace(/,/g,'')+'" />&nbsp;&nbsp;'+panda_lang_h001+'&nbsp;<input id="panda_size" style="width:50px;" value="'+panda_width+'" onblur="panda_width=parseInt(document.getElementById(\'panda_size\').value);document.cookie=\'panda_width=\'+panda_width+\';path=/;domain=.exhentai.org\';document.getElementById(\'panda_list\').style.width=panda_width+\'px\';" />&nbsp;&nbsp;原图&nbsp;<input type="checkbox" '+(panda_orign?'checked="checked"':'')+' onclick="document.cookie=\'panda_orign=\'+this.checked+\';path=/;domain=.exhentai.org\';" /></h4><h4><a href="javascript:;" onclick="panda_listshow();">竖屏看图</a>&nbsp;&nbsp;<a href="javascript:;" onclick="alert(\'功能暂未开发\');">打包下载</a>&nbsp;&nbsp;<a href="javascript:;" onclick="alert(\'test\');">切换账号</a></h4></div><div id="panda_list" style="margin:auto;max-width:100%;"></div>';
};
