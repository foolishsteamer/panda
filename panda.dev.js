...
document.getElementById('nb').innerHTML+='<div class="gm"><center><h4><a href="https://loligit.github.io/panda/" target="_blank">PANDA.JS</a></h4><h4>页码&nbsp;<input style="width:50px;" />&nbsp;-&nbsp;<input style="width:50px;" />&nbsp;&nbsp;宽度&nbsp;<input style="width:50px;" />&nbsp;&nbsp;原图&nbsp;<input type="checkbox" /></h4><h4><a href="javascript:;" onclick="alert(\'test\');">竖屏看图</a>&nbsp;&nbsp;<a href="javascript:;" onclick="alert(\'功能暂未开发\');">打包下载</a>&nbsp;&nbsp;<a href="javascript:;" onclick="alert(\'test\');">切换账号</a></h4></center></div>';
};
