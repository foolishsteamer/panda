...
//var panda_filepick=prompt(panda_lang_p001,panda_gnavi[1].replace(/,/g,'')+','+panda_gnavi[2].replace(/,/g,''));
document.getElementById('nb').innerHTML+='<div id="panda_gplus" class="gm" style="text-align:center;"><h4>页码&nbsp;<input style="width:50px;" value="'+panda_gnavi[1].replace(/,/g,'')+'" />&nbsp;-&nbsp;<input style="width:50px;" value="'+panda_gnavi[2].replace(/,/g,'')+'" />&nbsp;&nbsp;'+panda_lang_h001+'&nbsp;<input id="panda_size" style="width:50px;" value="'+panda_width+'" onblur="panda_width=parseInt(document.getElementById(\'panda_size\').value);document.cookie=\'panda_width=\'+panda_width+\';path=/;domain=.exhentai.org\';document.getElementById(\'panda_list\').style.width=panda_width+\'px\';" />&nbsp;&nbsp;原图&nbsp;<input id="panda_orig" type="checkbox" value="'+panda_orign+'" onclick="document.cookie=\'panda_orign=\'+document.getElementById(\'panda_orig\').value+\';path=/;domain=.exhentai.org\';" /></h4><h4><a href="javascript:;" onclick="alert(\'test\');">竖屏看图</a>&nbsp;&nbsp;<a href="javascript:;" onclick="alert(\'功能暂未开发\');">打包下载</a>&nbsp;&nbsp;<a href="javascript:;" onclick="alert(\'test\');">切换账号</a></h4></div><div id="panda_viewer"></div>';
};
